...
angular.module('App', []).controller('postNewBook', ['$scope', '$filter', '$http', app]).controller('account', ['$scope', '$http', '$window', account]).controller('detail', ['$scope', '$http', '$window', account]);
