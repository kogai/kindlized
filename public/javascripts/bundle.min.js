...
var account, analytics, app, author, intro, search;
...
]).controller('postNewBook', ['$scope', '$filter', '$http', app]).controller('account', ['$scope', '$http', '$window', '$location', account]).controller('intro', ['$scope', '$http', '$window', intro]).controller('author', ['$scope', '$http', '$http', author]).controller('search', ['$scope', '$filter', '$http', search]);



},{"./lib/account":2,"./lib/analytics":3,"./lib/app":4,"./lib/author":5,"./lib/intro":7,"./lib/search":8}],2:[function(require,module,exports){
