...
angular.module('App', []).controller('postNewBook', ['$scope', '$filter', '$http', app]).controller('account', ['$scope', '$http', '$window', account]);
...
},{"./imageStrModifyer":4}],4:[function(require,module,exports){
module.exports = function(bookList) {
  return bookList.map(function(book) {
    var images;
    images = JSON.parse(book.images);
    return book.images = images[0].ImageSet[0].MediumImage[0].URL;
  });
};
