...
var account, analytics, app, intro;
...
angular.module('App', []).controller('postNewBook', ['$scope', '$filter', '$http', app]).controller('account', ['$scope', '$http', '$window', account]).controller('intro', ['$scope', '$http', '$window', intro]);

analytics();



},{"./lib/account":2,"./lib/analytics":3,"./lib/app":4,"./lib/intro":6}],2:[function(require,module,exports){
module.exports = function($scope, $http, $window, account) {
...
},{"./imageStrModifyer":5}],5:[function(require,module,exports){
