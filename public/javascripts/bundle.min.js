...
angular.module('App', []).controller('postNewBook', ['$scope', '$filter', '$http', app]).controller('account', ['$scope', '$http', '$window', account]).controller('intro', ['$scope', '$http', '$window', intro]).controller('author', ['$scope', '$http', '$http', author]);
