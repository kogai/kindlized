...
var account, analytics, app, author, intro, reload, search;
...
]).controller('postNewBook', ['$scope', '$filter', '$http', app]).controller('account', ['$scope', '$http', '$window', '$location', account]).controller('intro', ['$scope', '$http', '$window', intro]).controller('author', ['$scope', '$http', '$http', author]).controller('search', ['$scope', '$filter', '$http', search]).controller('reload', ['$scope', '$window', reload]);



},{"./lib/account":2,"./lib/analytics":3,"./lib/app":4,"./lib/author":5,"./lib/intro":7,"./lib/reload":8,"./lib/search":9}],2:[function(require,module,exports){
...
module.exports = function($scope, $filter, $http) {
  ...
  $scope.search = function(newBook) {
    ...
    $http(httpOptToDB).success(function(data, status) {
      ...
      $http(httpOptToAmazon).success(function(bookListInAmazon, status) {
...
module.exports = function($scope, $filter, $http) {
  return $scope.search = function(newBook) {
    var completeTasks, httpOptToAmazon, httpOptToDB, isCompleteAmazon, isCompleteDB;
    $scope.isWaiting = true;
    $scope.bookListInDB = [];
    isCompleteDB = false;
